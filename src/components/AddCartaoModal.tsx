...
import { useCreateCartao } from "@/hooks/useCartoes";
...
export function AddCartaoModal({ trigger, open: controlledOpen, setOpen: controlledSetOpen }: AddCartaoModalProps) {
    ...
    createCartao.mutate(
      {
        ...
        is_principal: false, // Novos cartões não são principais por padrão
      ...
      <DialogContent className="w-full max-w-2xl rounded-2xl px-6 py-6">
        <DialogHeader className="space-y-1">
          ...
          <DialogDescription className="text-sm text-[#6B7280]">
            Informe os dados essenciais para controlar limite e uso.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex-1 min-w-0 grid gap-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                disabled={createCartao.isPending}
              >
                {createCartao.isPending ? "Salvando..." : "Cadastrar"}
              </Button>
            </div>
          </div>
        </form>
