...
const footerLinks = {
  produto: [
    ...
    { href: "#", label: "Roteiro" },
    { href: "#", label: "Registro de Alterações" },
  ],
  empresa: [
...
const FooterGrid = () => (
  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
    <FooterBrand />
    <FooterLinkSection title="Produto" links={footerLinks.produto} />
    <FooterLinkSection title="Empresa" links={footerLinks.empresa} />
...
const FooterBrand = () => (
  <div className="space-y-4">
    ...
    <p className="text-pretty text-sm text-muted-foreground">
      A forma mais inteligente de rastrear seu dinheiro. Gestão de finanças
      pessoais bonita, simples e poderosa.
    </p>
  </div>
);
...
const FooterBottom = () => (
  <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/40 pt-8 sm:flex-row">
    <p className="text-sm text-muted-foreground">
      © 2025 cofrin.io. Todos os direitos reservados.
    </p>
    <SocialLinks />
  </div>
);
